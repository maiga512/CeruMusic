...
export const useGlobalPlayStatusStore = defineStore(
  ...
  () => {
    ...
    function appendComments(list: Comment[], items: Comment[], max = MAX_COMMENT_CACHE) {
      ...
      try {
        ...
        if (type === 'hot') {
          if (page === 1) {
            ...
            appendComments(player.comments.hotList, res.comments || [])
          }
          ...
          if (page === 1) {
            ...
            appendComments(player.comments.latestList, res.comments || [])
          }

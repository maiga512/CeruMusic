        ...
        <div v-else :class="playlistSongsClass" :style="wrapperProps.style">
          ...
          >
            ...
            <div class="song-cover">
              <img :src="item.data.img || '/default-cover.png'" alt="封面" />
            </div>
...
.playlist-container.full-screen-mode .playlist-song .song-cover {
